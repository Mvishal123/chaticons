...
export const HeroButton = () => {
  return (
    <div className="w-full h-full bg-black flex flex-col items-center justify-center overflow-hidden">
      <Button
        className="border-t border-t-sky-400 hover:outline-b hover:outline-b-indigo-500 transition-all font-sans font-medium text-xl flex items-center gap-4 group"
        size={"xl"}
      >
        Get started
